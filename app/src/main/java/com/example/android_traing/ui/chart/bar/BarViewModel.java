package com.example.android_traing.ui.chart.bar;

import androidx.lifecycle.LiveData;
import androidx.lifecycle.MutableLiveData;
import androidx.lifecycle.ViewModel;

import com.example.android_traing.bean.BarBean;
import com.example.android_traing.bean.LineBean;
...
public class BarViewModel extends ViewModel {
    ...
    public LiveData<List<BarBean>> getLineList() {
        return barList;
    }
}